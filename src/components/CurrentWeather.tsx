            ...
            <Card shadow="sm" p="md" style={{ width: 250, height: 350 }}>
              <Group position="apart">
                <Title order={1} style={{ lineHeight: 1.5 }}>
                  ...
                  <Text size="md">Pressure: {data.current.pressure_in} in</Text>
                  <Text size="md">Pressure: {data.current.pressure_mb} mb</Text>
                </Title>
              </Group>
            </Card>
          </Grid.Col>
          ...
          >
            <Card shadow="sm" p="md" style={{ width: 250, height: 350 }}>
              ...
              >
                Conditions
                {tempUnit === "imperial" ? (
                  <Text size="md">Visibility: {data.current.vis_miles} in</Text>
                ) : (
